...
# Project:  GUI.pro
# Template: app
# Command: C:\Qt\5.9.1\mingw53_32\bin\qmake.exe -o Makefile GUI.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: GUI.pro ../../../../Qt/5.9.1/mingw53_32/mkspecs/win32-g++/qmake.conf ../../../../Qt/5.9.1/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile GUI.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
